...
export const requestNewConfirmEmail = asyncHandler(async (req, res, next) => {
    ...
    return res.status(200).send('<p>New confirmEmail Email have been sent to your inbox please check it ASAP. </p>')
})
...
export const login = asyncHandler(async (req, res, next) => {
    ...
    if (!user.confirmEmail) {
        return next(new Error("please confirm your email address", { cause: 400 }))
    }
